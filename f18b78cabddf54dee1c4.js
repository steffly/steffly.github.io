...
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    /* harmony export */ });
    /* harmony import */ var oauth4webapi__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! oauth4webapi */ "./node_modules/oauth4webapi/build/index.js");
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return oauth4webapi__WEBPACK_IMPORTED_MODULE_5__.discoveryRequest(issuer, {
                algorithm: 'oidc'
              }).then(function (response) {
                return oauth4webapi__WEBPACK_IMPORTED_MODULE_5__.processDiscoveryResponse(issuer, response);
              });
            case 4:
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return oauth4webapi__WEBPACK_IMPORTED_MODULE_5__.refreshTokenGrantRequest(state.authServer, state.client, refreshToken);
            case 3:
              response = _context4.sent;
              _context4.next = 6;
              return oauth4webapi__WEBPACK_IMPORTED_MODULE_5__.processRefreshTokenResponse(state.authServer, state.client, response);
            case 6:
              result = _context4.sent;
              if (!oauth4webapi__WEBPACK_IMPORTED_MODULE_5__.isOAuth2Error(result)) {
                _context4.next = 11;
                break;
              }
      ...
      _getInitialAuthUrl = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(state) {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              state.codeVerifier = oauth4webapi__WEBPACK_IMPORTED_MODULE_5__.generateRandomCodeVerifier();
              _context5.next = 3;
              return oauth4webapi__WEBPACK_IMPORTED_MODULE_5__.calculatePKCECodeChallenge(state.codeVerifier);
            case 3:
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              parameters = oauth4webapi__WEBPACK_IMPORTED_MODULE_5__.validateAuthResponse(state.authServer, state.client, url, state.authState);
              if (!oauth4webapi__WEBPACK_IMPORTED_MODULE_5__.isOAuth2Error(parameters)) {
                _context6.next = 5;
                break;
              }
            ...
            case 5:
              ...
              _context6.next = 8;
              return oauth4webapi__WEBPACK_IMPORTED_MODULE_5__.authorizationCodeGrantRequest(state.authServer, state.client, parameters, state.authCallbackUrl, state.codeVerifier);
            case 8:
              response = _context6.sent;
              _context6.next = 11;
              return oauth4webapi__WEBPACK_IMPORTED_MODULE_5__.processAuthorizationCodeOAuth2Response(state.authServer, state.client, response);
            case 11:
    ...
    console.log('auth redirect hide')

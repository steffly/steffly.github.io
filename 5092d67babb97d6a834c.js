...
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    __webpack_require__.r(__webpack_exports__);
    /* harmony export */ __webpack_require__.d(__webpack_exports__, {
    /* harmony export */   "getSpinnerStyling": () => (/* binding */ getSpinnerStyling)
    /* harmony export */ });
    ...
    function showSpinner(state) {
      state.spinner.style.visibility = "visible";
    }
    function hideSpinner(state) {
      state.spinner.style.visibility = "none";
    }
    function prepareStateInitial(inputState) {
      ...
      iframeContainer.appendChild((0,_spinner__WEBPACK_IMPORTED_MODULE_8__.getSpinnerStyling)());
      ...
      _openSplashSendOrAuth = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(state) {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              showSpinner(state);
              console.log('openSplashSendOrAuth - show');
              _context4.next = 4;
            ...
            case 4:
              ...
              state.iframe.setAttribute("src", sendUrl);
              hideSpinner(state);
              console.log('openSplashSendOrAuth - hide');
              _context4.next = 13;
              break;
            case 12:

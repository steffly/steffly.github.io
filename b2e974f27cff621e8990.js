    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          ...
          (0,_utils__WEBPACK_IMPORTED_MODULE_1__.openPopup)(authUrl.toString(), 'remitlyAuthWindow');
        case 5:
        case "end":
  ...
  _downgradeAndRedirect = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(state, result) {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.prev = 0;
          console.log('downgradeAndRedirect');
          (0,_spinner__WEBPACK_IMPORTED_MODULE_4__.showSpinner)(state);
        ...
        case 29:
          ...
          (0,_utils__WEBPACK_IMPORTED_MODULE_1__.openPopup)(sendUrl, 'remitlyWindow');
        case 31:
          _context7.next = 36;
          break;
        case 33:
  ...
  _initializeCalls = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(state) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 37:
          state.areCookiesBlocked = !deid;
        case 38:
          (0,_utils__WEBPACK_IMPORTED_MODULE_0__.log)(state, "Async initialization complete; cookies are ".concat(state.areCookiesBlocked ? '' : 'not ', "blocked"));
        case 39:
        case "end":
          return _context.stop();
      }
    }, _callee, null, [[15, 21], [29, 35]]);
  }));
  return _initializeCalls.apply(this, arguments);
}
...
function getSplashUrl(state) {
  var allowLoginSignup = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  var _a;
  ...
  if (allowLoginSignup) params.set('ce_final_page', 'loginsignup');
  return url.href;
}
...
function openPopup(url, name) {
  var width = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 420;
  var height = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 640;
  var top = window.screen.height / 2 - height / 2;
  var left = window.screen.width / 2 - width / 2;
  window.open(url.toString(), name, "width=".concat(width, ",height=").concat(height, ",top=").concat(top, ",left=").concat(left));
}
...
function _openSplashSendOrAuth() {
  _openSplashSendOrAuth = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(state) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          if (!state.areCookiesBlocked) {
            _context4.next = 4;
            break;
          }
          console.log('openSplashSendOrAuth openPopup');
          (0,_utils__WEBPACK_IMPORTED_MODULE_3__.openPopup)((0,_urls__WEBPACK_IMPORTED_MODULE_4__.getSplashUrl)(state), 'remitlyWindow');
          return _context4.abrupt("return");
        case 4:
          console.log('openSplashSendOrAuth showSpinner');
